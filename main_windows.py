...
ruta_iconbit_P1 = ruta_madre_P1 + r"/Data_Image/HK_038.ico"
ventana.iconbitmap(ruta_iconbit_P1)
imagen = PhotoImage(file="Data_Image/window_contraste.png")

background = Label(image=imagen, text="")
...
def opcion():
    ...
    ruta_iconbit_opcion = ruta_madre_opcion + r"/Data_Image/config_icon.ico"
    ...
    def error_type():
        ...
        ruta_iconbit_guide = ruta_madre_guide + r"/Data_Image/config_icon.ico"
...
def guide():
    ...
    ruta_iconbit_guide = ruta_madre_guide + r"/Data_Image/config_icon.ico"
    ventana_guide.iconbitmap(ruta_iconbit_guide)
    ventana_guide.iconbitmap("Data_Image/config_icon.ico")
    mensaje = tk.Text(ventana_guide, background="white", width=165, height=25)
    mensaje.grid(row=1, column=2, sticky="ENS")
    mensaje.insert(INSERT, """
